...
namespace VissmaFlow.Core.Migrations
{
    ...
    [Migration("20240529092758_add_zond_measure_settings")]
    partial class addzondmeasuresettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VissmaFlow.Core.Models.ZondMeasuring.ZondMeasure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("ZondMeasureSettingsId")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.HasIndex("ZondMeasureSettingsId");

                    b.ToTable("ZondMeasure");
                });

            modelBuilder.Entity("VissmaFlow.Core.Models.ZondMeasuring.ZondMeasureSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("ZondMeasureSettingses");
                });
            ...
            modelBuilder.Entity("VissmaFlow.Core.Models.ZondMeasuring.ZondMeasure", b =>
                {
                    b.HasOne("VissmaFlow.Core.Models.ZondMeasuring.ZondMeasureSettings", null)
                        .WithMany("ZondMeasures")
                        .HasForeignKey("ZondMeasureSettingsId");
                });
